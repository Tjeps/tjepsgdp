...
<main>
  ...
  <div class="container-fluid topPane">
    <div class="container">
      <div class="row justify-content-center">
        <div id="topPane" class="col-md-12 text-center" runat="server"></div>
      </div>
    </div>
  </div>
  
    <div class="container-fluid fullBannerPane">
      <div class="row justify-content-center">
        <div id="fullBannerPane" class="col-md-12 text-center" runat="server"></div>
      </div>
  </div>
  ...
  <div class="container-fluid bg-tertiary">
    <div class="container">
      <div class="row align-items-center">
        <div id="FullWidthBGPane" class="col-md-12 cpy-5" runat="server"></div>
      </div>
    </div>
  </div>
